...
device = torch.device("cpu")
dataset = doublemnist("C:/Users/ASUS/Documents/GitHub/BOAT/data/", ways=5, shots=1, test_shots=15, meta_train=True,download=True)
test_dataset = doublemnist("C:/Users/ASUS/Documents/GitHub/BOAT/data/", ways=5, shots=1, test_shots=15, meta_test=True,download=True)

meta_model = get_cnn_omniglot(32, 5)
