...
device = torch.device("cpu")
dataset = cifar_fs("C:/Users/ASUS/Documents/GitHub/BOAT/data/", ways=5, shots=1, test_shots=15, meta_train=True,download=True)
test_dataset = cifar_fs("C:/Users/ASUS/Documents/GitHub/BOAT/data/", ways=5, shots=1, test_shots=15, meta_test=True,download=True)
