...
class VFM(HyperGradient):
    r"""Calculation of the gradient of the upper adapt_model variables with BVFIM method
        ...
        Note that this UL optimization module should only use boat.ll_solver.BVFIM
    ...
    def __init__(
        ...
        super(VFM, self).__init__(ul_objective, ul_model, ll_model)
