        ...
        def check_model_structure(model1, model2):
            for param1, param2 in zip(model1.parameters(), model2.parameters()):
                ...
                if param1.dtype != param2.dtype:
                    return False
            return True
        assert check_model_structure(self.ll_model, self.ul_model), "With 'IAD' or 'FOA' operation, the 'ul' model must have the same structure and dtype as the 'll_model', and the 'll variables' should initialize to the 'ul variables'. "
