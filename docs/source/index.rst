...
In this section, we explain the core components of BOAT-Jittor, how to install the Jittor version, and how to use it for your optimization tasks. The main contents are organized as follows.
